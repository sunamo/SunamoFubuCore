...
public class ConverterLibrary : DescribesItself
{
    ...
    public ConverterLibrary(IEnumerable<IObjectConverterFamily> families)
    {
        ...
        _families.Add(new TimeSpanConverterFubu());
    ...
    public IEnumerable<IObjectConverterFamily> AllConverterFamilies => _families;
    ...
    private IConverterStrategy createFinder(Type type)
    {
        ...
        if (family != null) return family.CreateConverter(type, t => _froms[t]);
