...
public class DateTimeConverter : StatelessConverter<DateTime>
{
    ...
    private static readonly Regex iso8601Expression = new Regex(
    ...
    public static DateTime GetDateTime(string dateString)
    {
        ...
        if (trimmedString == TODAY) return DateTime.Today;
        ...
        if (isDayOfWeek(dateString)) return convertToDateFromDayAndTime(dateString);
