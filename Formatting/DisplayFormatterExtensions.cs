...
public static class DisplayFormatterExtensions
{
    ...
    ///     The type of the model to which the accessor belongs (i.e. Case where the accessor might be on
    ///     its base class WorkflowItem)
    /// </param>
    ...
    /// </summary>
    /// <param name="modelType">
    ///     The type of the model to which the property belongs (i.e. Case where the property might be on
    ///     its base class WorkflowItem)
    /// </param>
    /// <param name="formatter">The formatter</param>
